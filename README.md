...
- **n** – Force next turn
- **r** – Dispense beer for the Red team (servo rotates counterclockwise)
- **g** – Dispense beer for the Green team (servo rotates clockwise)
...
Dispensing a beer also spins **Servo 1** attached to the taps. The Red button
rotates it 100° counterclockwise and the Green button rotates it 100° clockwise;
after three seconds the servo returns to the centre.
...
| `dispense(team)` | Activate the beer dispenser for the given team |
